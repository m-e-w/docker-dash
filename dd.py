...
def get_processes(): 
    ...
    for line in ss_split_lines[1:]:
        ...
        for proc, pid in matches:
            ...
            if local_port not in process_set[name]['listen_ports'] and local_port < 32768: # if its listening in the high ephemeral port range it probably is TCP response traffic
