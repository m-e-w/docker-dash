...
class DashApp:
    ...
    def serve_layout(self):
        ...
        elements = None
        if self.layout_serve_count > 1: # Avoid calling process_container_data on the first layout serves dash performs (only load data once the user navigates to page)
    ...
    def register_callbacks(self):
        @self.app.callback(Output('cytoscape-tapNodeData-json', 'children'), Input('cytoscape', 'tapNodeData'), prevent_initial_call=True)
